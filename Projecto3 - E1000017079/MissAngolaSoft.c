...
/*****************************************Função Seleccionar as candidatas que mais se aproximam**********************************************************************************/
void numero(int id, int *max, int *media, int *min, char nome[], char nomeA[], char nomeB[], char nomeC[])
{
